...
- **Phase**: Phase 0 + 1 + 2 + 3 + 4 + 5 ✅，總計 **30/41**
- **Spec 狀態**: V2 已含 8 項微調建議（已套用）；B04 走自製 backtester 取代 vectorbt（spec drift 記在 PROGRESS）
- **下一 task**: **TASK-R03 Correlation Filter**；或先補 chip/news/margin 至 ≥2 年再回頭做 V1 正式 V2 §6.1 判決
- **Blocked**: 無
- **Pytest**: J03 25/25 GREEN；完整 pytest 535/535 GREEN（12 warnings）
