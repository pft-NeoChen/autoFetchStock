...
- **Phase**: Phase 0 + 1 + 2 + 3 + 4 ✅，總計 **27/41**
- **Spec 狀態**: V2 已含 8 項微調建議（已套用）；B04 走自製 backtester 取代 vectorbt（spec drift 記在 PROGRESS）
- **下一 task**: **TASK-J01 TradeJournal**；或先補 chip/news/margin 至 ≥2 年再回頭做 V1 正式 V2 §6.1 判決
- **Blocked**: 無
- **Pytest**: R02 8/8 GREEN；portfolio 18/18 GREEN；相關 suite 61/61 GREEN；完整 pytest 受本機缺 `scipy` 影響 collection 中斷
